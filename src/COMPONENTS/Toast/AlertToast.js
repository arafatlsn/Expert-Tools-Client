...
const AlertToast = () => {
  return (
    <div id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute top-[5%] left-[43%]" role="alert">
