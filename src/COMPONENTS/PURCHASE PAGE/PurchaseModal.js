...
const PurchaseModal = ({ tool, getQuantity, setShowModal, setConfirmModal, setPurchaseObj }) => {
            ...
            >
              ...
              <Modal.Body className="space-y-6 px-6 pb-4 sm:pb-6 lg:px-8 xl:pb-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <input type="email" name="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" value={user.email} readOnly 
                  ...
                  {
                    errors.phoneNumber?.type === 'required' && <span className='text-red-500'>{errors.phoneNumber?.message}</span>
                  }
                  ...
                  <div className='flex'>
                    ...
                    <div className='flex flex-col justify-center items-center ml-[1rem]'>
                      <h1 className='text-[2rem]' style={{color: 'rgba(48, 56, 65, 1)'}}>Total: ${(price * getQuantity).toFixed(1)} </h1>
                      <div>
