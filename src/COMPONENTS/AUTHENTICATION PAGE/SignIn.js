...
const SignIn = () => {
  ...
  return (
    <div className='w-[50%] h-[80vh] mx-auto bg-gradient-to-r from-[#FEEDD3] to-[#A0CBF5] px-[5rem] py-[4rem] mt-[2rem] rounded-xl'>
            ...
            {
              errorSignInEmailPass && <ErrorComp message={errorSignInEmailPass?.message?.split(':')[1]?.split('/')[1]?.split(')')[0]}></ErrorComp>
            }
            ...
            <p className='text-center mt-[11px]'>New to Doctors Portal? <Link className='text-lightBlue underline' to={'/signup'}>Create New Account</Link></p>
